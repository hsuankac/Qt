...
void Dialog::substract()
{
    updateAction(Equation::Action::SUBSTRACT);
}
...
void Dialog::init()
{
    ...
    QPushButton *btnSubstract = new QPushButton("-", this);
    ...
    connect(btnSubstract, &QPushButton::clicked, this, &Dialog::substract);
    ...
    ui->gridLayout->addWidget(btnSubstract, 1, 3);
