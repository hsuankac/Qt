...
{
    QString path = QFileDialog::getSaveFileName(this, "Save", "", "To-Do (*.td)");
    if(path.isEmpty()) return;
    save(path);
}
...
void MainWindow::createItem(Qt::CheckState state, QString name)
{
    ...
    item->setFlags(Qt::ItemFlag::ItemIsEnabled | Qt::ItemFlag::ItemIsEditable | Qt::ItemFlag::ItemIsUserTristate | Qt::ItemFlag::ItemIsUserCheckable | Qt::ItemIsSelectable);
