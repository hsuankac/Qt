...
void MainWindow::on_actionDelete_triggered()
{
    ...
    m_model.setStringList(m_list);
    m_changed = true;
    ui->statusbar->showMessage("Delete", 2000);
}
...
{
    if(!m_changed | m_list.isEmpty()) return;
    QMessageBox::StandardButton btn = QMessageBox::question(this, "Save Changes?", "Would you like to save your changes");
